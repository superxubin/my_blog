...
$.ajax({
    ...
    data: {
        key: 'RQEBZ-Z7MEJ-GJNF5-FQXBF-UN34V-SMB4O',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.280018, 23.243745, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    else if (date.getHours() >= 16 && date.getHours() < 19) timeChange = "<span>等下班啦🍉，</span>";
